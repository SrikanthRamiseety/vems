...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.loginPage("/login.jsp").failureUrl("/login.jsp")
		...
		.authenticated().and()
		.formLogin().loginPage("/loginpage_l.jsp").permitAll().failureUrl("/login.jsp")
		.loginProcessingUrl("/j_spring_security_check")
		.defaultSuccessUrl("/admin/landingpage_vendor", true).and()
		...
		.antMatchers("/upload/**").permitAll().anyRequest()
		.authenticated().and()
		.formLogin().loginPage("/login.jsp").permitAll().failureUrl("/login.jsp")
		.loginProcessingUrl("/j_spring_security_check")
		.defaultSuccessUrl("/user/landingpageOfEmplyee", true).and()
		.logout().logoutSuccessUrl("/").and().csrf().disable();
		/*http.authorizeRequests().antMatchers("/css/**").permitAll()
		...
		.permitAll().antMatchers("/bootstrap/**").permitAll()
		.antMatchers("/upload/**").permitAll().anyRequest()
		.authenticated().antMatchers("/admin/*").access("hasRole('ROLE_ADMIN')").and()
		.formLogin().loginPage("/loginpage_l.jsp").permitAll().failureUrl("/login.jsp")
		.loginProcessingUrl("/j_spring_security_check")
		.defaultSuccessUrl("/admin/landingpage_vendor", true).and()
		.logout().logoutSuccessUrl("/").and().csrf().disable();
		...
		.permitAll().antMatchers("/bootstrap/**").permitAll()
		.antMatchers("/upload/**").permitAll().anyRequest()
		.authenticated().antMatchers("/user/*").access("hasRole('ROLE_USER')").and()
		.formLogin().loginPage("/login.jsp").permitAll().failureUrl("/login.jsp")
		.loginProcessingUrl("/j_spring_security_check")
		.defaultSuccessUrl("/user/landingpageOfEmplyee", true).and()
		.logout().logoutSuccessUrl("/").and().csrf().disable();*/
